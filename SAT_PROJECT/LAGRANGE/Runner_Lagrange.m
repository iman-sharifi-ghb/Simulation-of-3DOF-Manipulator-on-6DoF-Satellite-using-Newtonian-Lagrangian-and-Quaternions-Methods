...
t0=clock;
[t,z]=ode45(@Lagrange_SAT_DYNAMIC,timeSpan,[q_0;dq_0],options);
t1=clock;
time_Lag=etime(t1,t0);
disp(['Lagrage SAT_DYNAMIC sim time: ' num2str(time_Lag) '(s)'])
...
function dz=Lagrange_SAT_DYNAMIC(t,z)
...
Q = [fX;fY;fZ;0;0;-tav1;tav1;tav2-tav3;tav3];
